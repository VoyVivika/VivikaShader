...
Shader "VoyVivika/VivikaShader"
{
	Properties
	{
		...
		[Enum(None,0,UV Vertical,1,UV Distance Out,2,Texture,3)]_ALUVToggle("Delay for AL", Float) = 0
		...
		[SingleLineTexture]_ALDelayMap("AL Delay Map", 2D) = "white" {}
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half2 break63_g466 = floor( half2( 0,0 ) );
			half temp_output_8_0_g468 = 0.0;
			half discUVset2314 = _DiscardUVMap;
			half temp_output_7_0_g468 = discUVset2314;
			half2 lerpResult6_g468 = lerp( half2( 0,0 ) , v.texcoord.xy , ( step( temp_output_8_0_g468 , temp_output_7_0_g468 ) * step( temp_output_7_0_g468 , temp_output_8_0_g468 ) ));
			...
			half2 DiscardUV200 = ( lerpResult6_g468 + lerpResult6_g423 + lerpResult6_g424 + lerpResult6_g431 );
			half2 break61_g466 = DiscardUV200;
			half2 break63_g465 = floor( half2( 0,1 ) );
			half2 break61_g465 = DiscardUV200;
			half2 break63_g464 = floor( half2( 0,2 ) );
			half2 break61_g464 = DiscardUV200;
			half2 break63_g463 = floor( half2( 0,3 ) );
			half2 break61_g463 = DiscardUV200;
			half2 break63_g467 = floor( half2( 1,0 ) );
			half2 break61_g467 = DiscardUV200;
			half2 break63_g460 = floor( half2( 1,1 ) );
			half2 break61_g460 = DiscardUV200;
			half2 break63_g461 = floor( half2( 1,2 ) );
			half2 break61_g461 = DiscardUV200;
			half2 break63_g462 = floor( half2( 1,3 ) );
			half2 break61_g462 = DiscardUV200;
			half2 break63_g458 = floor( half2( 2,0 ) );
			half2 break61_g458 = DiscardUV200;
			half2 break63_g457 = floor( half2( 2,1 ) );
			half2 break61_g457 = DiscardUV200;
			half2 break63_g456 = floor( half2( 2,2 ) );
			half2 break61_g456 = DiscardUV200;
			half2 break63_g455 = floor( half2( 2,3 ) );
			half2 break61_g455 = DiscardUV200;
			half2 break63_g451 = floor( half2( 3,0 ) );
			half2 break61_g451 = DiscardUV200;
			half2 break63_g452 = floor( half2( 3,1 ) );
			half2 break61_g452 = DiscardUV200;
			half2 break63_g453 = floor( half2( 3,2 ) );
			half2 break61_g453 = DiscardUV200;
			half2 break63_g454 = floor( half2( 3,3 ) );
			half2 break61_g454 = DiscardUV200;
			half UVTileDiscard192 = ( step( 1.0 , ( ( ( saturate( _DiscardUVTile00 ) * saturate( ( step( break63_g466.x , break61_g466.x ) * step( break61_g466.x , ( break63_g466.x + 0.9999999 ) ) * step( break63_g466.y , break61_g466.y ) * step( break61_g466.y , ( break63_g466.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile01 ) * saturate( ( step( break63_g465.x , break61_g465.x ) * step( break61_g465.x , ( break63_g465.x + 0.9999999 ) ) * step( break63_g465.y , break61_g465.y ) * step( break61_g465.y , ( break63_g465.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile02 ) * saturate( ( step( break63_g464.x , break61_g464.x ) * step( break61_g464.x , ( break63_g464.x + 0.9999999 ) ) * step( break63_g464.y , break61_g464.y ) * step( break61_g464.y , ( break63_g464.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile03 ) * saturate( ( step( break63_g463.x , break61_g463.x ) * step( break61_g463.x , ( break63_g463.x + 0.9999999 ) ) * step( break63_g463.y , break61_g463.y ) * step( break61_g463.y , ( break63_g463.y + 0.9999999 ) ) ) ) ) ) + ( ( saturate( _DiscardUVTile10 ) * saturate( ( step( break63_g467.x , break61_g467.x ) * step( break61_g467.x , ( break63_g467.x + 0.9999999 ) ) * step( break63_g467.y , break61_g467.y ) * step( break61_g467.y , ( break63_g467.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile11 ) * saturate( ( step( break63_g460.x , break61_g460.x ) * step( break61_g460.x , ( break63_g460.x + 0.9999999 ) ) * step( break63_g460.y , break61_g460.y ) * step( break61_g460.y , ( break63_g460.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile12 ) * saturate( ( step( break63_g461.x , break61_g461.x ) * step( break61_g461.x , ( break63_g461.x + 0.9999999 ) ) * step( break63_g461.y , break61_g461.y ) * step( break61_g461.y , ( break63_g461.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile13 ) * saturate( ( step( break63_g462.x , break61_g462.x ) * step( break61_g462.x , ( break63_g462.x + 0.9999999 ) ) * step( break63_g462.y , break61_g462.y ) * step( break61_g462.y , ( break63_g462.y + 0.9999999 ) ) ) ) ) ) + ( ( saturate( _DiscardUVTile20 ) * saturate( ( step( break63_g458.x , break61_g458.x ) * step( break61_g458.x , ( break63_g458.x + 0.9999999 ) ) * step( break63_g458.y , break61_g458.y ) * step( break61_g458.y , ( break63_g458.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile21 ) * saturate( ( step( break63_g457.x , break61_g457.x ) * step( break61_g457.x , ( break63_g457.x + 0.9999999 ) ) * step( break63_g457.y , break61_g457.y ) * step( break61_g457.y , ( break63_g457.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile22 ) * saturate( ( step( break63_g456.x , break61_g456.x ) * step( break61_g456.x , ( break63_g456.x + 0.9999999 ) ) * step( break63_g456.y , break61_g456.y ) * step( break61_g456.y , ( break63_g456.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile23 ) * saturate( ( step( break63_g455.x , break61_g455.x ) * step( break61_g455.x , ( break63_g455.x + 0.9999999 ) ) * step( break63_g455.y , break61_g455.y ) * step( break61_g455.y , ( break63_g455.y + 0.9999999 ) ) ) ) ) ) + ( ( saturate( _DiscardUVTile30 ) * saturate( ( step( break63_g451.x , break61_g451.x ) * step( break61_g451.x , ( break63_g451.x + 0.9999999 ) ) * step( break63_g451.y , break61_g451.y ) * step( break61_g451.y , ( break63_g451.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile31 ) * saturate( ( step( break63_g452.x , break61_g452.x ) * step( break61_g452.x , ( break63_g452.x + 0.9999999 ) ) * step( break63_g452.y , break61_g452.y ) * step( break61_g452.y , ( break63_g452.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile32 ) * saturate( ( step( break63_g453.x , break61_g453.x ) * step( break61_g453.x , ( break63_g453.x + 0.9999999 ) ) * step( break63_g453.y , break61_g453.y ) * step( break61_g453.y , ( break63_g453.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile33 ) * saturate( ( step( break63_g454.x , break61_g454.x ) * step( break61_g454.x , ( break63_g454.x + 0.9999999 ) ) * step( break63_g454.y , break61_g454.y ) * step( break61_g454.y , ( break63_g454.y + 0.9999999 ) ) ) ) ) ) ) ) == 1.0 ? ( 0.0 / 0.0 ) : 0.0 );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half3 temp_cast_16 = (_IndirectDiffuseOffset).xxx;
			half temp_output_8_0_g432 = 1.0;
			half temp_output_7_0_g432 = _IndirLightUseMinforMax;
			half lerpResult6_g432 = lerp( _IndirectDiffuseOffsetMax , _IndirectDiffuseOffset , ( step( temp_output_8_0_g432 , temp_output_7_0_g432 ) * step( temp_output_7_0_g432 , temp_output_8_0_g432 ) ));
			half3 clampResult2396 = clamp( indirectDiffuse1348 , saturate( ( localShadeSH92384 - temp_cast_16 ) ) , saturate( ( localShadeSH92384 + lerpResult6_g432 ) ) );
			half3 indirDiffuse2394 = clampResult2396;
			half3 temp_cast_17 = (1.0).xxx;
			half4 temp_cast_19 = (_MinBrightness).xxxx;
			half4 color2383 = IsGammaSpace() ? half4(1,1,1,1) : half4(1,1,1,1);
			half4 clampResult2381 = clamp( saturate( ( saturate( ( DiffWrapStep11229 + saturate( exp2( temp_output_2255_0 ) ) ) ) * saturate( ( saturate( lerpResult1356 ) + half4( saturate( (saturate( ( exp2( saturate( indirDiffuse2394 ) ) - temp_cast_17 ) )*_WrapIndirScale + 0.0) ) , 0.0 ) ) ) ) ) , temp_cast_19 , color2383 );
			half4 DiffWrapLighting1363 = clampResult2381;
			half temp_output_8_0_g479 = 0.0;
			half vpUVoption2482 = _VideoPlayerDecalUV;
			half temp_output_7_0_g479 = vpUVoption2482;
			half2 lerpResult6_g479 = lerp( half2( 0,0 ) , i.uv_texcoord , ( step( temp_output_8_0_g479 , temp_output_7_0_g479 ) * step( temp_output_7_0_g479 , temp_output_8_0_g479 ) ));
			half temp_output_8_0_g472 = 1.0;
			half temp_output_7_0_g472 = vpUVoption2482;
			half2 lerpResult6_g472 = lerp( half2( 0,0 ) , i.uv2_texcoord2 , ( step( temp_output_8_0_g472 , temp_output_7_0_g472 ) * step( temp_output_7_0_g472 , temp_output_8_0_g472 ) ));
			half temp_output_8_0_g473 = 2.0;
			half temp_output_7_0_g473 = vpUVoption2482;
			half2 lerpResult6_g473 = lerp( half2( 0,0 ) , i.uv3_texcoord3 , ( step( temp_output_8_0_g473 , temp_output_7_0_g473 ) * step( temp_output_7_0_g473 , temp_output_8_0_g473 ) ));
			half temp_output_8_0_g474 = 3.0;
			half temp_output_7_0_g474 = vpUVoption2482;
			half2 lerpResult6_g474 = lerp( half2( 0,0 ) , i.uv4_texcoord4 , ( step( temp_output_8_0_g474 , temp_output_7_0_g474 ) * step( temp_output_7_0_g474 , temp_output_8_0_g474 ) ));
			half2 vpUV2500 = ( lerpResult6_g479 + lerpResult6_g472 + lerpResult6_g473 + lerpResult6_g474 );
			...
			float cos7_g469 = cos( _VideoDecalRotation );
			float sin7_g469 = sin( _VideoDecalRotation );
			half2 rotator7_g469 = mul( temp_output_1076_0 - float2( 0.5,0.5 ) , float2x2( cos7_g469 , -sin7_g469 , sin7_g469 , cos7_g469 )) + float2( 0.5,0.5 );
			half2 break6_g469 = rotator7_g469;
			half VideoDecalAlpha1118 = ( (( break6_g469.y >= 0.0 && break6_g469.y <= 1.0 ) ? (( break6_g469.x >= 0.0 && break6_g469.x <= 1.0 ) ? 1.0 :  0.0 ) :  0.0 ) * _EnableDecal );
			...
			half4 lerpResult1129 = lerp( (( break6_g469.y >= 0.0 && break6_g469.y <= 1.0 ) ? (( break6_g469.x >= 0.0 && break6_g469.x <= 1.0 ) ? tex2D( _Udon_VideoTex, rotator7_g469 ) :  float4( 0,0,0,0 ) ) :  float4( 0,0,0,0 ) ) , (( break6_g324.y >= 0.0 && break6_g324.y <= 1.0 ) ? (( break6_g324.x >= 0.0 && break6_g324.x <= 1.0 ) ? tex2D( _VideoDecalPreview, rotator7_g324 ) :  float4( 0,0,0,0 ) ) :  float4( 0,0,0,0 ) ) , _ShowVideoPreview);
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			half2 DelayUV2355 = ( lerpResult6_g470 + lerpResult6_g427 + lerpResult6_g428 + lerpResult6_g478 );
			half3 hsvTorgb2458 = RGBToHSV( tex2D( _ALDelayMap, DelayUV2355 ).rgb );
			half temp_output_8_0_g477 = 3.0;
			half ALDelay2470 = _ALUVToggle;
			half temp_output_7_0_g477 = ALDelay2470;
			half lerpResult6_g477 = lerp( distance( appendResult986 , DelayUV2355 ) , hsvTorgb2458.z , ( step( temp_output_8_0_g477 , temp_output_7_0_g477 ) * step( temp_output_7_0_g477 , temp_output_8_0_g477 ) ));
			half clampResult987 = clamp( (0.0 + (lerpResult6_g477 - 0.0) * (_ALUVDelayMaxDelay - 0.0) / (1.0 - 0.0)) , 0.0 , 127.0 );
			half temp_output_8_0_g483 = _ALUVToggle;
			half lerpResult10_g483 = lerp( 0.0 , clampResult987 , ( step( 2.0 , temp_output_8_0_g483 ) * step( temp_output_8_0_g483 , 3.0 ) ));
			half clampResult982 = clamp( (0.0 + (DelayUV2355.y - 0.0) * (_ALUVDelayMaxDelay - 0.0) / (_ALDelayVPosition - 0.0)) , 0.0 , 127.0 );
			half temp_output_8_0_g476 = 1.0;
			half temp_output_7_0_g476 = _ALUVToggle;
			half lerpResult6_g476 = lerp( lerpResult10_g483 , (127.0 + (clampResult982 - 0.0) * (0.0 - 127.0) / (127.0 - 0.0)) , ( step( temp_output_8_0_g476 , temp_output_7_0_g476 ) * step( temp_output_7_0_g476 , temp_output_8_0_g476 ) ));
			half in_ALDelay991 = round( lerpResult6_g476 );
...
Node;AmplifyShaderEditor.CommentaryNode;1276;-451.2643,-10403.85;Inherit;False;2609.462;2341.557;Comment;6;1277;1278;1313;1365;1279;2401;Diffuse Wrapped;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;2401;-412.7138,-8786.773;Inherit;False;1521.969;674.606;Comment;18;2415;2413;2392;2416;2414;2408;2412;2411;2409;1347;2384;1348;2394;2396;2388;2389;2393;2390;Indirect Diffuse (Light Probes/Baked Lighting);1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;1279;-423.5098,-9588.972;Inherit;False;1763.379;699.0471;I really hated this bit;32;1363;2290;2291;2367;2372;2371;2369;2283;2395;2375;2383;2381;2306;2257;2305;2302;1355;2260;1326;2259;2286;1389;2285;1388;2255;1390;2258;2256;1274;1273;1362;1356;Light Color & More Indirect Calculations;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;1275;-1495.297,-9171.703;Inherit;False;735.2146;441.0371;Dot Product of Normal and Light Dir;8;2266;2265;2264;1204;1254;1206;1205;1203;NdotL;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;120;-1771.553,-2723.966;Inherit;False;Property;_EmissionStrength;Emission Strength;24;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;118;-1797.104,-2926.999;Inherit;True;Property;_Emission;Emission;23;0;Create;True;0;0;0;False;0;False;-1;83f90c05f51ea5c469ceb2c4218b09a7;83f90c05f51ea5c469ceb2c4218b09a7;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;762;1499.583,-759.6893;Inherit;False;Property;_DiscardUVTile01;Discard UV Tile 0,1;31;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;763;1496.973,-427.7367;Inherit;False;Property;_DiscardUVTile02;Discard UV Tile 0,2;32;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;764;1518.973,-60.73669;Inherit;False;Property;_DiscardUVTile03;Discard UV Tile 0,3;33;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;765;2249.126,-963.5736;Inherit;False;Property;_DiscardUVTile10;Discard UV Tile 1,0;34;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;766;2259.126,-613.5735;Inherit;False;Property;_DiscardUVTile11;Discard UV Tile 1,1;35;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;209;3140.744,-871.4884;Inherit;False;200;DiscardUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;770;3041.102,-947.6624;Inherit;False;Property;_DiscardUVTile20;Discard UV Tile 2,0;38;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;774;3842.005,-910.9678;Inherit;False;Property;_DiscardUVTile30;Discard UV Tile 3,0;43;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;775;3839.91,-560.7627;Inherit;False;Property;_DiscardUVTile31;Discard UV Tile 3,1;42;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;776;3813.138,-254.3136;Inherit;False;Property;_DiscardUVTile32;Discard UV Tile 3,2;44;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;777;3814.721,53.09606;Inherit;False;Property;_DiscardUVTile33;Discard UV Tile 3,3;45;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;771;3055.927,-642.5212;Inherit;False;Property;_DiscardUVTile21;Discard UV Tile 2,1;39;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;772;3061.227,-323.6906;Inherit;False;Property;_DiscardUVTile22;Discard UV Tile 2,2;40;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;212;3166.697,60.64629;Inherit;False;200;DiscardUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;773;3067.304,-14.54724;Inherit;False;Property;_DiscardUVTile23;Discard UV Tile 2,3;41;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;767;2251.573,-307.925;Inherit;False;Property;_DiscardUVTile12;Discard UV Tile 1,2;36;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;768;2260.751,5.167598;Inherit;False;Property;_DiscardUVTile13;Discard UV Tile 1,3;37;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;977;-3566.635,-6071.09;Inherit;False;1946.786;821.5767;Comment;27;2507;2506;984;2505;2457;2471;2468;2462;986;2472;2458;2470;991;985;2363;2365;987;982;999;979;981;993;983;978;2508;2509;2510;UV Delay AudioLink;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;736;-4547.432,-4929.197;Inherit;True;Property;_Albedo;Albedo;7;0;Create;True;0;0;0;False;0;False;0db631ddb1a2c1443b81c6ac5ce43d11;7a3af6d336f8abd4fb3c0a3c5258c085;False;black;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.LightColorNode;1274;-336.9002,-9266.962;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1229;193.9252,-10184.55;Inherit;False;DiffWrapStep1;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldNormalVector;1203;-1309.297,-8957.703;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;1205;-1342.297,-9106.703;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.DotProductOpNode;1206;-1112.297,-9105.703;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1254;-1000.322,-9108.174;Inherit;False;NdotL;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1204;-1476.297,-8964.703;Inherit;False;1002;normalMap;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;2264;-1301.668,-8811.638;Inherit;False;1254;NdotL;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;2265;-1119.876,-8820.055;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;2266;-970.876,-8825.055;Inherit;False;NdotLSaturated;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SaturateNode;2286;741.3151,-9505.961;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;2302;1248.983,-9358.385;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;2305;1122.984,-9299.385;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;737;-4425.451,-2467.993;Inherit;True;Property;_NormalMap;Normal Map;8;0;Create;True;0;0;0;False;0;False;0f9978e19d98bb04b8f2ce5197640506;0f9978e19d98bb04b8f2ce5197640506;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;1004;-4300.542,-5804.715;Inherit;True;Property;_EmissionMap;Fallback Emission Map;54;1;[SingleLineTexture];Create;False;0;0;0;True;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;1003;-4295.542,-6000.715;Inherit;True;Property;_MainTex;Fallback Albedo;52;2;[Header];[SingleLineTexture];Create;False;1;Standard Fallbacks;0;0;True;0;False;None;7a3af6d336f8abd4fb3c0a3c5258c085;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.ColorNode;1005;-4058.832,-5795.639;Inherit;False;Property;_EmissionColor;Fallback Emission Color;55;0;Create;False;0;0;0;True;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;2307;-4059.833,-5990.872;Inherit;False;Property;_Color;Fallback Color;53;0;Create;False;0;0;0;True;0;False;1,1,1,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;198;1543.344,-979.7899;Inherit;False;200;DiscardUV;1;0;OBJECT;;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;270;1497.07,-1070.585;Inherit;False;Property;_DiscardUVTile00;Discard UV Tile 0,0;30;1;[ToggleUI];Create;True;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-590.4416,-903.1979;Float;False;Property;_RimPower;Rim Power;26;0;Create;True;0;0;0;False;0;False;2.07;4.59;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-306.0728,-806.6133;Inherit;False;Property;_RimEnergy;Rim Energy;27;0;Create;True;0;0;0;False;0;False;0.345;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;112;-203.138,-719.0771;Inherit;False;26;mainTex;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;113;-283.1368,-639.0771;Inherit;False;Property;_RimBaseColorStrength;Rim Base Color Strength;28;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;333;256.8146,-929.4459;Half;False;Property;_EnableRimLighting;Enable Rim Lighting;25;1;[ToggleUI];Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1006;-4300.907,-5611.498;Inherit;True;Property;_BumpMap;Fallback Normal Map;56;1;[SingleLineTexture];Create;False;0;0;0;True;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.WireNode;2306;1021.341,-9270.701;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;2381;971.2732,-9167.466;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,1;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;2383;736.9007,-9093.938;Inherit;False;Constant;_Color0;Color 0;56;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;2313;2090.464,641.9681;Inherit;False;Property;_DiscardUVMap;Discard UV Map;29;2;[Header];[Enum];Create;True;1;UV Tile Discarding;4;UV0;0;UV1;1;UV2;2;UV3;3;0;True;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;2395;-324.4717,-9143.956;Inherit;False;2394;indirDiffuse;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1363;1121.607,-9245.764;Inherit;False;DiffWrapLighting;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;2413;150.5898,-8350.622;Inherit;False;If Float Equal;-1;;432;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2375;667.6304,-9169.382;Inherit;False;Property;_MinBrightness;Min Brightness;1;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2434;4148.061,-787.4337;Inherit;False;UV Tile Checker;-1;;451;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2435;4155.061,-506.4337;Inherit;False;UV Tile Checker;-1;;452;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2436;4142.061,-217.4337;Inherit;False;UV Tile Checker;-1;;453;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2437;4140.061,73.56628;Inherit;False;UV Tile Checker;-1;;454;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2438;3383.047,37.1557;Inherit;False;UV Tile Checker;-1;;455;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2439;3368.047,-283.8443;Inherit;False;UV Tile Checker;-1;;456;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2440;3356.047,-582.8443;Inherit;False;UV Tile Checker;-1;;457;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2441;3351.047,-865.8442;Inherit;False;UV Tile Checker;-1;;458;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2443;2550.401,-554.9913;Inherit;False;UV Tile Checker;-1;;460;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2444;2548.401,-255.9913;Inherit;False;UV Tile Checker;-1;;461;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2445;2567.401,74.00867;Inherit;False;UV Tile Checker;-1;;462;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2446;1800.911,-3.485718;Inherit;False;UV Tile Checker;-1;;463;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2447;1785.775,-345.7103;Inherit;False;UV Tile Checker;-1;;464;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2448;1788.775,-622.7103;Inherit;False;UV Tile Checker;-1;;465;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2449;1764.775,-968.7103;Inherit;False;UV Tile Checker;-1;;466;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2442;2547.401,-851.9913;Inherit;False;UV Tile Checker;-1;;467;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2311;1774.179,726.7761;Inherit;False;If Float Equal;-1;;468;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RoundOpNode;985;-1996.866,-5958.629;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;991;-1858.02,-5955.763;Inherit;False;in_ALDelay;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;2470;-1993.101,-5686.701;Inherit;False;ALDelay;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RGBToHSVNode;2458;-3101.087,-5532.802;Inherit;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GetLocalVarNode;2472;-3096.615,-5614.223;Inherit;False;2470;ALDelay;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;986;-3220.573,-5754.957;Inherit;False;FLOAT2;4;0;FLOAT;0.5;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DistanceOpNode;2462;-3045.087,-5789.802;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1053;-3849.051,-3962.619;Inherit;True;Global;_Udon_VideoTex;_Udon_VideoTex;57;0;Create;True;0;0;0;True;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.FunctionNode;1135;-3552.285,-3682.727;Inherit;True;Decal;-1;;469;c7a5994071b70f8448ea324b9d90affe;0;4;9;SAMPLER2D;;False;15;FLOAT2;0,0;False;12;FLOAT2;0.5,0.5;False;14;FLOAT;0;False;2;COLOR;0;FLOAT;19
Node;AmplifyShaderEditor.Vector4Node;1064;-4498.177,-3540.394;Inherit;False;Property;_VideoDecalUVs;Video Decal Coordinates;50;1;[Header];Create;False;2;X and Y are Position;Z and W are Tiling (Size);0;0;False;0;False;0.01,-0.29,1.29,1.4;0.01,-0.29,1.29,1.4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;2338;-3782.334,-7965.802;Inherit;False;If Float Equal;-1;;470;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2357;-3466.049,-8049.611;Inherit;False;Property;_ALDelayUVMap;AL Delay UV Map;17;2;[Header];[Enum];Create;True;1;UV Tile Discarding;4;UV0;0;UV1;1;UV2;2;UV3;3;0;True;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2488;-5921.093,-3724.567;Inherit;False;If Float Equal;-1;;472;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;2493;-5768.796,-3398.89;Inherit;False;If Float Equal;-1;;473;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;2498;-5574.038,-3100.952;Inherit;False;If Float Equal;-1;;474;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2481;-5640.195,-4157.95;Inherit;False;Property;_VideoPlayerDecalUV;Video Player Decal UV Map;49;1;[Enum];Create;False;0;4;UV0;0;UV1;1;UV2;2;UV3;3;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;1124;-3878.399,-3256.554;Inherit;True;Property;_VideoDecalPreview;Decal Texture;47;1;[SingleLineTexture];Create;False;0;0;0;True;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;1083;-3476.276,-4001.301;Inherit;False;Property;_EnableDecal;Enable Decal;46;2;[Header];[ToggleUI];Create;True;1;Video Player Decal;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1108;-3527.153,-3412.754;Inherit;False;Property;_ShowVideoPreview;Custom Tex Instead of Video Tex;48;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1071;-3919.18,-3403.594;Inherit;False;Property;_VideoDecalRotation;Decal Rotation;51;0;Create;False;0;0;0;False;0;False;-0.15;-0.15;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2468;-2149.545,-5826.096;Inherit;False;If Float Equal;-1;;476;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;1;False;9;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2471;-2869.101,-5766.701;Inherit;False;If Float Equal;-1;;477;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;3;False;9;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;2457;-3414.087,-5567.802;Inherit;True;Property;_ALDelayMap;AL Delay Map;22;1;[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;2353;-3731.706,-6748.421;Inherit;False;If Float Equal;-1;;478;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;2476;-5735.497,-4058.647;Inherit;False;If Float Equal;-1;;479;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;984;-2526.103,-5758.253;Inherit;False;Property;_ALUVToggle;Delay for AL;16;1;[Enum];Create;False;0;4;None;0;UV Vertical;1;UV Distance Out;2;Texture;3;0;True;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2506;-2648.877,-5457.972;Inherit;False;Constant;_Float16;Float 16;58;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2507;-2644.877,-5384.972;Inherit;False;Constant;_Float17;Float 17;58;0;Create;True;0;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2505;-2274.877,-5642.972;Inherit;False;If Float in Range;-1;;483;fb43c64eec5b88541922ad5239a69a8c;0;5;8;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;14;FLOAT;0;False;13;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2508;-2402.315,-5413.435;Inherit;False;Constant;_Float18;Float 18;58;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2509;-2335.315,-5809.435;Inherit;False;Constant;_Float19;Float 19;58;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2510;-3053.633,-5685.82;Inherit;False;Constant;_Float20;Float 20;58;0;Create;True;0;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
...
WireConnection;985;0;2468;0
WireConnection;991;0;985;0
WireConnection;2470;0;984;0
WireConnection;2458;0;2457;0
WireConnection;986;0;999;0
WireConnection;986;1;978;0
WireConnection;2462;0;986;0
WireConnection;2462;1;2363;0
...
WireConnection;2468;7;984;0
WireConnection;2468;8;2509;0
WireConnection;2468;9;983;0
WireConnection;2468;10;2505;0
WireConnection;2471;7;2472;0
WireConnection;2471;8;2510;0
WireConnection;2471;9;2458;3
WireConnection;2471;10;2462;0
...
WireConnection;2505;8;984;0
WireConnection;2505;4;2506;0
WireConnection;2505;5;2507;0
WireConnection;2505;14;987;0
WireConnection;2505;13;2508;0
ASEEND*/
//CHKSM=8ED23E1721D58631E2257A9CF2EECC2E61A80984