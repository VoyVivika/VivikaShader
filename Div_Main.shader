...
Shader "VoyVivika/VivikaShader"
{
	Properties
	{
		...
		[Enum(UV0,0,UV1,1,UV2,2,UV3,3)]_ALDelayUVMap("AL Delay UV Map", Float) = 2
	...
	SubShader
	{
		...
		inline half AudioLinkData3_g487( int Band, int Delay )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( Delay, Band ) ).rrrr;
		}


		half IfAudioLinkv2Exists1_g494(  )
		{
			int w = 0; 
			int h; 
			int res = 0;
		...
		inline half AudioLinkData3_g491( int Band, int Delay )
		{
			return AudioLinkData( ALPASS_AUDIOLINK + uint2( Delay, Band ) ).rrrr;
		}
		...
		half IfAudioLinkv2Exists1_g500(  )
		{
			int w = 0; 
			int h; 
			int res = 0;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half2 break63_g515 = floor( half2( 0,0 ) );
			half temp_output_8_0_g498 = 0.0;
			half discUVset2314 = _DiscardUVMap;
			half temp_output_7_0_g498 = discUVset2314;
			half2 lerpResult6_g498 = lerp( half2( 0,0 ) , v.texcoord.xy , ( step( temp_output_8_0_g498 , temp_output_7_0_g498 ) * step( temp_output_7_0_g498 , temp_output_8_0_g498 ) ));
			half temp_output_8_0_g495 = 1.0;
			half temp_output_7_0_g495 = discUVset2314;
			half2 lerpResult6_g495 = lerp( half2( 0,0 ) , v.texcoord1.xy , ( step( temp_output_8_0_g495 , temp_output_7_0_g495 ) * step( temp_output_7_0_g495 , temp_output_8_0_g495 ) ));
			half temp_output_8_0_g496 = 2.0;
			half temp_output_7_0_g496 = discUVset2314;
			half2 lerpResult6_g496 = lerp( half2( 0,0 ) , v.texcoord2.xy , ( step( temp_output_8_0_g496 , temp_output_7_0_g496 ) * step( temp_output_7_0_g496 , temp_output_8_0_g496 ) ));
			half temp_output_8_0_g497 = 3.0;
			half temp_output_7_0_g497 = discUVset2314;
			half2 lerpResult6_g497 = lerp( half2( 0,0 ) , v.texcoord3.xy , ( step( temp_output_8_0_g497 , temp_output_7_0_g497 ) * step( temp_output_7_0_g497 , temp_output_8_0_g497 ) ));
			half2 DiscardUV200 = ( lerpResult6_g498 + lerpResult6_g495 + lerpResult6_g496 + lerpResult6_g497 );
			half2 break61_g515 = DiscardUV200;
			half2 break63_g514 = floor( half2( 0,1 ) );
			half2 break61_g514 = DiscardUV200;
			half2 break63_g513 = floor( half2( 0,2 ) );
			half2 break61_g513 = DiscardUV200;
			half2 break63_g512 = floor( half2( 0,3 ) );
			half2 break61_g512 = DiscardUV200;
			half2 break63_g516 = floor( half2( 1,0 ) );
			half2 break61_g516 = DiscardUV200;
			half2 break63_g509 = floor( half2( 1,1 ) );
			half2 break61_g509 = DiscardUV200;
			half2 break63_g510 = floor( half2( 1,2 ) );
			half2 break61_g510 = DiscardUV200;
			half2 break63_g511 = floor( half2( 1,3 ) );
			half2 break61_g511 = DiscardUV200;
			half2 break63_g508 = floor( half2( 2,0 ) );
			half2 break61_g508 = DiscardUV200;
			half2 break63_g507 = floor( half2( 2,1 ) );
			half2 break61_g507 = DiscardUV200;
			half2 break63_g506 = floor( half2( 2,2 ) );
			half2 break61_g506 = DiscardUV200;
			half2 break63_g505 = floor( half2( 2,3 ) );
			half2 break61_g505 = DiscardUV200;
			half2 break63_g501 = floor( half2( 3,0 ) );
			half2 break61_g501 = DiscardUV200;
			half2 break63_g502 = floor( half2( 3,1 ) );
			half2 break61_g502 = DiscardUV200;
			half2 break63_g503 = floor( half2( 3,2 ) );
			half2 break61_g503 = DiscardUV200;
			half2 break63_g504 = floor( half2( 3,3 ) );
			half2 break61_g504 = DiscardUV200;
			half UVTileDiscard192 = ( step( 1.0 , ( ( ( saturate( _DiscardUVTile00 ) * saturate( ( step( break63_g515.x , break61_g515.x ) * step( break61_g515.x , ( break63_g515.x + 0.9999999 ) ) * step( break63_g515.y , break61_g515.y ) * step( break61_g515.y , ( break63_g515.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile01 ) * saturate( ( step( break63_g514.x , break61_g514.x ) * step( break61_g514.x , ( break63_g514.x + 0.9999999 ) ) * step( break63_g514.y , break61_g514.y ) * step( break61_g514.y , ( break63_g514.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile02 ) * saturate( ( step( break63_g513.x , break61_g513.x ) * step( break61_g513.x , ( break63_g513.x + 0.9999999 ) ) * step( break63_g513.y , break61_g513.y ) * step( break61_g513.y , ( break63_g513.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile03 ) * saturate( ( step( break63_g512.x , break61_g512.x ) * step( break61_g512.x , ( break63_g512.x + 0.9999999 ) ) * step( break63_g512.y , break61_g512.y ) * step( break61_g512.y , ( break63_g512.y + 0.9999999 ) ) ) ) ) ) + ( ( saturate( _DiscardUVTile10 ) * saturate( ( step( break63_g516.x , break61_g516.x ) * step( break61_g516.x , ( break63_g516.x + 0.9999999 ) ) * step( break63_g516.y , break61_g516.y ) * step( break61_g516.y , ( break63_g516.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile11 ) * saturate( ( step( break63_g509.x , break61_g509.x ) * step( break61_g509.x , ( break63_g509.x + 0.9999999 ) ) * step( break63_g509.y , break61_g509.y ) * step( break61_g509.y , ( break63_g509.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile12 ) * saturate( ( step( break63_g510.x , break61_g510.x ) * step( break61_g510.x , ( break63_g510.x + 0.9999999 ) ) * step( break63_g510.y , break61_g510.y ) * step( break61_g510.y , ( break63_g510.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile13 ) * saturate( ( step( break63_g511.x , break61_g511.x ) * step( break61_g511.x , ( break63_g511.x + 0.9999999 ) ) * step( break63_g511.y , break61_g511.y ) * step( break61_g511.y , ( break63_g511.y + 0.9999999 ) ) ) ) ) ) + ( ( saturate( _DiscardUVTile20 ) * saturate( ( step( break63_g508.x , break61_g508.x ) * step( break61_g508.x , ( break63_g508.x + 0.9999999 ) ) * step( break63_g508.y , break61_g508.y ) * step( break61_g508.y , ( break63_g508.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile21 ) * saturate( ( step( break63_g507.x , break61_g507.x ) * step( break61_g507.x , ( break63_g507.x + 0.9999999 ) ) * step( break63_g507.y , break61_g507.y ) * step( break61_g507.y , ( break63_g507.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile22 ) * saturate( ( step( break63_g506.x , break61_g506.x ) * step( break61_g506.x , ( break63_g506.x + 0.9999999 ) ) * step( break63_g506.y , break61_g506.y ) * step( break61_g506.y , ( break63_g506.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile23 ) * saturate( ( step( break63_g505.x , break61_g505.x ) * step( break61_g505.x , ( break63_g505.x + 0.9999999 ) ) * step( break63_g505.y , break61_g505.y ) * step( break61_g505.y , ( break63_g505.y + 0.9999999 ) ) ) ) ) ) + ( ( saturate( _DiscardUVTile30 ) * saturate( ( step( break63_g501.x , break61_g501.x ) * step( break61_g501.x , ( break63_g501.x + 0.9999999 ) ) * step( break63_g501.y , break61_g501.y ) * step( break61_g501.y , ( break63_g501.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile31 ) * saturate( ( step( break63_g502.x , break61_g502.x ) * step( break61_g502.x , ( break63_g502.x + 0.9999999 ) ) * step( break63_g502.y , break61_g502.y ) * step( break61_g502.y , ( break63_g502.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile32 ) * saturate( ( step( break63_g503.x , break61_g503.x ) * step( break61_g503.x , ( break63_g503.x + 0.9999999 ) ) * step( break63_g503.y , break61_g503.y ) * step( break61_g503.y , ( break63_g503.y + 0.9999999 ) ) ) ) ) + ( saturate( _DiscardUVTile33 ) * saturate( ( step( break63_g504.x , break61_g504.x ) * step( break61_g504.x , ( break63_g504.x + 0.9999999 ) ) * step( break63_g504.y , break61_g504.y ) * step( break61_g504.y , ( break63_g504.y + 0.9999999 ) ) ) ) ) ) ) ) == 1.0 ? ( 0.0 / 0.0 ) : 0.0 );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			half4 temp_output_2258_0 = saturate( lerpResult1356 );
			UnityGI gi1348 = gi;
			...
			half temp_output_8_0_g479 = 1.0;
			half temp_output_7_0_g479 = _IndirLightUseMinforMax;
			half lerpResult6_g479 = lerp( _IndirectDiffuseOffsetMax , _IndirectDiffuseOffset , ( step( temp_output_8_0_g479 , temp_output_7_0_g479 ) * step( temp_output_7_0_g479 , temp_output_8_0_g479 ) ));
			half3 temp_output_2393_0 = saturate( ( localShadeSH92384 + lerpResult6_g479 ) );
			...
			half4 clampResult2381 = clamp( saturate( ( saturate( ( DiffWrapStep11229 + saturate( exp2( temp_output_2255_0 ) ) ) ) * saturate( ( temp_output_2258_0 + half4( saturate( (saturate( ( exp2( saturate( indirDiffuse2394 ) ) - temp_cast_19 ) )*_WrapIndirScale + 0.0) ) , 0.0 ) ) ) ) ) , temp_cast_21 , color2383 );
			...
			half VideoDecalAlpha1118 = ( (( break6_g485.y >= 0.0 && break6_g485.y <= 1.0 ) ? (( break6_g485.x >= 0.0 && break6_g485.x <= 1.0 ) ? 1.0 :  0.0 ) :  0.0 ) * _EnableDecal );
			float2 uv_Albedo = i.uv_texcoord * _Albedo_ST.xy + _Albedo_ST.zw;
			float cos7_g484 = cos( _VideoDecalRotation );
			float sin7_g484 = sin( _VideoDecalRotation );
			half2 rotator7_g484 = mul( temp_output_1076_0 - float2( 0.5,0.5 ) , float2x2( cos7_g484 , -sin7_g484 , sin7_g484 , cos7_g484 )) + float2( 0.5,0.5 );
			half2 break6_g484 = rotator7_g484;
			half4 lerpResult1129 = lerp( (( break6_g485.y >= 0.0 && break6_g485.y <= 1.0 ) ? (( break6_g485.x >= 0.0 && break6_g485.x <= 1.0 ) ? tex2D( _Udon_VideoTex, rotator7_g485 ) :  float4( 0,0,0,0 ) ) :  float4( 0,0,0,0 ) ) , (( break6_g484.y >= 0.0 && break6_g484.y <= 1.0 ) ? (( break6_g484.x >= 0.0 && break6_g484.x <= 1.0 ) ? tex2D( _VideoDecalPreview, rotator7_g484 ) :  float4( 0,0,0,0 ) ) :  float4( 0,0,0,0 ) ) , _ShowVideoPreview);
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float3 hsvTorgb4_g486 = RGBToHSV( color42.rgb );
			half mulTime48 = _Time.y * _ALTimeScale;
			half Time50 = frac( mulTime48 );
			float3 hsvTorgb8_g486 = HSVToRGB( float3(( hsvTorgb4_g486.x + Time50 ),( hsvTorgb4_g486.y + 0.0 ),( hsvTorgb4_g486.z + 0.0 )) );
			half3 temp_output_194_0 = saturate( hsvTorgb8_g486 );
			int Band3_g487 = 0;
			...
			int Delay3_g487 = (int)in_ALDelay991;
			half localAudioLinkData3_g487 = AudioLinkData3_g487( Band3_g487 , Delay3_g487 );
			half temp_output_8_0_g499 = 1.0;
			half localIfAudioLinkv2Exists1_g494 = IfAudioLinkv2Exists1_g494();
			half temp_output_7_0_g499 = localIfAudioLinkv2Exists1_g494;
			half3 lerpResult6_g499 = lerp( temp_output_194_0 , ( temp_output_194_0 * localAudioLinkData3_g487 ) , ( step( temp_output_8_0_g499 , temp_output_7_0_g499 ) * step( temp_output_7_0_g499 , temp_output_8_0_g499 ) ));
			half3 ALC_Bass61 = lerpResult6_g499;
			half4 color44 = IsGammaSpace() ? half4(0,0.8196079,0,1) : half4(0,0.637597,0,1);
			float3 hsvTorgb4_g490 = RGBToHSV( color44.rgb );
			...
			half3 ALC_HighMid67 = ( saturate( hsvTorgb8_g490 ) * localAudioLinkData3_g492 );
			half4 color43 = IsGammaSpace() ? half4(1,0.9294118,0,1) : half4(1,0.8468735,0,1);
			float3 hsvTorgb4_g489 = RGBToHSV( color43.rgb );
			float3 hsvTorgb8_g489 = HSVToRGB( float3(( hsvTorgb4_g489.x + Time50 ),( hsvTorgb4_g489.y + 0.0 ),( hsvTorgb4_g489.z + 0.0 )) );
			int Band3_g491 = 1;
			int Delay3_g491 = (int)in_ALDelay991;
			half localAudioLinkData3_g491 = AudioLinkData3_g491( Band3_g491 , Delay3_g491 );
			half3 ALC_LowMid64 = ( saturate( hsvTorgb8_g489 ) * localAudioLinkData3_g491 );
			half4 color45 = IsGammaSpace() ? half4(0,0,1,1) : half4(0,0,1,1);
			float3 hsvTorgb4_g488 = RGBToHSV( color45.rgb );
			float3 hsvTorgb8_g488 = HSVToRGB( float3(( hsvTorgb4_g488.x + Time50 ),( hsvTorgb4_g488.y + 0.0 ),( hsvTorgb4_g488.z + 0.0 )) );
			int Band3_g493 = 3;
			int Delay3_g493 = (int)in_ALDelay991;
			half localAudioLinkData3_g493 = AudioLinkData3_g493( Band3_g493 , Delay3_g493 );
			half3 ALC_Treble70 = ( saturate( hsvTorgb8_g488 ) * localAudioLinkData3_g493 );
			half localIfAudioLinkv2Exists1_g500 = IfAudioLinkv2Exists1_g500();
			half4 AL_Final85 = ( ( _EnableAudioLink * ( ( ALMask39 * half4( ALC_Bass61 , 0.0 ) ) + ( ALMask39 * half4( ALC_HighMid67 , 0.0 ) ) + ( ALMask39 * half4( ALC_LowMid64 , 0.0 ) ) + ( ALMask39 * half4( ALC_Treble70 , 0.0 ) ) ) ) * saturate( ( localIfAudioLinkv2Exists1_g500 + _ALEmitifInactive ) ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;2357;-3466.049,-8049.611;Inherit;False;Property;_ALDelayUVMap;AL Delay UV Map;17;2;[Header];[Enum];Create;True;0;4;UV0;0;UV1;1;UV2;2;UV3;3;0;True;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;2401;-412.7138,-8786.773;Inherit;False;1521.969;674.606;Comment;20;2415;2413;2392;2416;2414;2408;2412;2411;2409;1347;2384;1348;2394;2396;2388;2389;2393;2390;2502;2531;Indirect Diffuse (Light Probes/Baked Lighting);1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;2413;150.5898,-8350.622;Inherit;False;If Float Equal;-1;;479;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;1279;-423.5098,-9588.972;Inherit;False;2538.892;696.345;I really hated this bit;30;2381;2375;2520;1363;2383;2260;1326;2259;2286;1355;1389;2257;2285;1388;2258;2290;1390;1356;2291;2367;2255;2256;1362;1273;2372;1274;2371;2369;2283;2395;Light Color & More Indirect Calculations;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;1136;-3539.927,-3312.314;Inherit;True;Decal;-1;;484;c7a5994071b70f8448ea324b9d90affe;0;4;9;SAMPLER2D;;False;15;FLOAT2;0,0;False;12;FLOAT2;0.5,0.5;False;14;FLOAT;0;False;2;COLOR;0;FLOAT;19
Node;AmplifyShaderEditor.FunctionNode;1135;-3552.285,-3682.727;Inherit;True;Decal;-1;;485;c7a5994071b70f8448ea324b9d90affe;0;4;9;SAMPLER2D;;False;15;FLOAT2;0,0;False;12;FLOAT2;0.5,0.5;False;14;FLOAT;0;False;2;COLOR;0;FLOAT;19
...
Node;AmplifyShaderEditor.FunctionNode;194;-960.5157,-5788.812;Inherit;False;HueShift;-1;;486;09c7357f8ce789c46a405a6704ca8341;0;4;14;COLOR;0,0,0,0;False;15;FLOAT;0;False;16;FLOAT;0;False;17;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1009;-973.2197,-5635.942;Inherit;False;4BandAmplitude;-1;;487;54e9597243c613f4e9d8abb2df35c1e0;0;2;2;INT;0;False;4;INT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;195;343.6559,-5323.875;Inherit;False;HueShift;-1;;488;09c7357f8ce789c46a405a6704ca8341;0;4;14;COLOR;0,0,0,0;False;15;FLOAT;0;False;16;FLOAT;0;False;17;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;196;-907.4175,-5335.405;Inherit;False;HueShift;-1;;489;09c7357f8ce789c46a405a6704ca8341;0;4;14;COLOR;0,0,0,0;False;15;FLOAT;0;False;16;FLOAT;0;False;17;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;197;368.8238,-5818.455;Inherit;False;HueShift;-1;;490;09c7357f8ce789c46a405a6704ca8341;0;4;14;COLOR;0,0,0,0;False;15;FLOAT;0;False;16;FLOAT;0;False;17;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1008;-913.0733,-5171.95;Inherit;False;4BandAmplitude;-1;;491;54e9597243c613f4e9d8abb2df35c1e0;0;2;2;INT;1;False;4;INT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1010;368.6584,-5617.326;Inherit;False;4BandAmplitude;-1;;492;54e9597243c613f4e9d8abb2df35c1e0;0;2;2;INT;2;False;4;INT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;1011;331.6262,-5142.257;Inherit;False;4BandAmplitude;-1;;493;54e9597243c613f4e9d8abb2df35c1e0;0;2;2;INT;3;False;4;INT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1012;-743.153,-5891.785;Inherit;False;IsAudioLink;-1;;494;ff5333ab7aa196b46b61532e86c1a947;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2322;1769.645,1149.8;Inherit;False;If Float Equal;-1;;495;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;2327;1770.158,1549.696;Inherit;False;If Float Equal;-1;;496;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;2332;1824.807,1944.158;Inherit;False;If Float Equal;-1;;497;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;2311;1774.179,726.7761;Inherit;False;If Float Equal;-1;;498;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;2213;-556.2672,-5832.83;Inherit;False;If Float Equal;-1;;499;bdca1c28487c8a1418e72579bec63589;0;4;7;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT3;0,0,0;False;10;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2502;683.6627,-8560.327;Inherit;False;maxIndirLight;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;1043;743,-4456;Inherit;False;IsAudioLink;-1;;500;ff5333ab7aa196b46b61532e86c1a947;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2434;4148.061,-787.4337;Inherit;False;UV Tile Checker;-1;;501;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2435;4155.061,-506.4337;Inherit;False;UV Tile Checker;-1;;502;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2436;4142.061,-217.4337;Inherit;False;UV Tile Checker;-1;;503;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2437;4140.061,73.56628;Inherit;False;UV Tile Checker;-1;;504;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;2438;3383.047,37.1557;Inherit;False;UV Tile Checker;-1;;505;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2439;3368.047,-283.8443;Inherit;False;UV Tile Checker;-1;;506;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2440;3356.047,-582.8443;Inherit;False;UV Tile Checker;-1;;507;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2441;3351.047,-865.8442;Inherit;False;UV Tile Checker;-1;;508;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2443;2550.401,-554.9913;Inherit;False;UV Tile Checker;-1;;509;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2444;2548.401,-255.9913;Inherit;False;UV Tile Checker;-1;;510;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2445;2567.401,74.00867;Inherit;False;UV Tile Checker;-1;;511;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2446;1800.911,-3.485718;Inherit;False;UV Tile Checker;-1;;512;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2447;1785.775,-345.7103;Inherit;False;UV Tile Checker;-1;;513;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2448;1788.775,-622.7103;Inherit;False;UV Tile Checker;-1;;514;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2449;1764.775,-968.7103;Inherit;False;UV Tile Checker;-1;;515;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;2442;2547.401,-851.9913;Inherit;False;UV Tile Checker;-1;;516;c43a818059b65cd448c0f67225beab6f;0;3;21;FLOAT;0;False;6;FLOAT2;0,0;False;10;FLOAT2;0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;2531;423.4756,-8341.748;Inherit;False;litmin;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;2520;429.8078,-9379.196;Inherit;False;idkLightColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=C802DC85AE0F1F622C9174D406431887710964FC