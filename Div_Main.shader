...
Shader "VoyVivika/VivikaShader"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aselc
			float4 clampResult1413 = clamp( ase_lightColor , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
			float4 lerpResult1356 = lerp( color1362 , clampResult1413 , clampResult1338);
			...
			float3 clampResult1496 = clamp( indirectDiffuse1348 , float3( 0,0,0 ) , float3( 1,1,1 ) );
			float4 clampResult1353 = clamp( ( clampResult1340 + float4( clampResult1496 , 0.0 ) ) , float4( 0,0,0,0 ) , color1317 );
			...
			float fresnelNode1393 = ( 0.0 + _WrapMetallicFesnelScale * pow( 1.0 - fresnelNdotV1393, 3.0 ) );
			float lerpResult1405 = lerp( fresnelNode1393 , 1.0 , _Metalic753);
			float4 AvatarColor1289 = ( mainTex26 + float4( ( indirectSpecular1410 * lerpResult1405 ) , 0.0 ) );
			float4 Lighting_Wrapped1144 = ( DiffWrapLighting1363 * AvatarColor1289 );
			float temp_output_8_0_g354 = 2.0;
			float LightType793 = _LightingType;
			float temp_output_7_0_g354 = LightType793;
			float4 lerpResult6_g354 = lerp( float4( Lighting_Standard309 , 0.0 ) , Lighting_Wrapped1144 , ( step( temp_output_8_0_g354 , temp_output_7_0_g354 ) * step( temp_output_7_0_g354 , temp_output_8_0_g354 ) ));
			float4 temp_output_2212_0 = lerpResult6_g354;
			float4 LightingFinal330 = temp_output_2212_0;
...
Node;AmplifyShaderEditor.CommentaryNode;1279;-625.3216,-8114.772;Inherit;False;2435.94;804.9821;I really hated this bit;21;1363;1317;1353;1413;1274;1348;1347;1352;1273;1362;1338;1388;1390;1389;1339;1315;1326;1340;1355;1356;1496;Lighting;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;120;-1771.553,-2723.966;Inherit;False;Property;_EmissionStrength;Emission Strength;20;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;415;478.4037,-4285.905;Half;False;Property;_EnableAudioLink;Enable AudioLink;11;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;40;-1793.337,-3445.624;Inherit;True;Property;_AL_Mask;AudioLink Mask;13;0;Create;False;0;0;0;False;0;False;-1;83f90c05f51ea5c469ceb2c4218b09a7;83f90c05f51ea5c469ceb2c4218b09a7;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;978;-3524.537,-5819.039;Inherit;False;Property;_ALDelayVPosition;AL Delay V Position;16;0;Create;True;0;0;0;False;0;False;0.83;0.83;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;984;-2526.103,-5758.253;Inherit;False;Property;_ALUVToggle;Delay for AL;14;1;[Enum];Create;False;0;3;None;0;UV Vertical;1;Distance;2;0;True;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;979;-3552.83,-5722.939;Inherit;False;Property;_ALUVDelayMaxDelay;AL UV Delay Max Delay;17;0;Create;True;0;0;0;False;0;False;0;127;0;127;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;999;-3524.789,-5897.548;Inherit;False;Property;_ALDelayUPosition;AL Delay U Position;15;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1037;743,-4376;Inherit;False;Property;_ALEmitifInactive;AL Emit if Inactive;12;1;[ToggleUI];Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1003;-8229.402,-4736.937;Inherit;True;Property;_MainTex;Fallback Albedo;46;2;[Header];[SingleLineTexture];Create;False;1;Standard Fallbacks;0;0;True;0;False;None;7a3af6d336f8abd4fb3c0a3c5258c085;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;1004;-8234.402,-4540.937;Inherit;True;Property;_EmissionMap;Fallback Emission Map;48;1;[SingleLineTexture];Create;False;0;0;0;True;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.ColorNode;1005;-8203.402,-4345.939;Inherit;False;Property;_EmissionColor;Fallback Emission Color;49;0;Create;False;0;0;0;True;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;1006;-8231.174,-4149.961;Inherit;True;Property;_BumpMap;Fallback Normal Map;50;1;[SingleLineTexture];Create;False;0;0;0;True;0;False;None;None;True;bump;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector4Node;1064;-4696.004,-3121;Inherit;False;Property;_VideoDecalUVs;Video Decal Coordinates;44;1;[Header];Create;False;2;X and Y are Position;Z and W are Tiling (Size);0;0;False;0;False;0.01,-0.29,1.29,1.4;0.01,-0.29,1.29,1.4;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;1071;-4117.007,-2984.2;Inherit;False;Property;_VideoDecalRotation;Video Decal Rotation;45;0;Create;True;0;0;0;False;0;False;-0.15;-0.15;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1108;-3615.98,-2997.36;Inherit;False;Property;_ShowVideoPreview;Show Preview;42;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1124;-4076.226,-2837.161;Inherit;True;Property;_VideoDecalPreview;Video Decal Preview;43;1;[SingleLineTexture];Create;False;0;0;0;True;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-2893.793,-360.0198;Float;False;Property;_RimPower;Rim Power;22;0;Create;True;0;0;0;False;0;False;2.07;4.59;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;87;-2609.424,-263.4352;Inherit;False;Property;_RimEnergy;Rim Energy;23;0;Create;True;0;0;0;False;0;False;0.345;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;113;-2586.488,-95.89901;Inherit;False;Property;_RimBaseColorStrength;Rim Base Color Strength;24;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;333;-2046.536,-386.2678;Half;False;Property;_EnableRimLighting;Enable Rim Lighting;21;1;[ToggleUI];Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;1411;319.6755,-8660.635;Inherit;False;755;_Smoothness;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;1338;-353.5112,-8050.338;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1362;-606.9088,-7971.989;Inherit;False;Constant;_Color1;Color 1;57;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LightAttenuation;1273;-609.3478,-8054.602;Inherit;False;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;1352;-455.2115,-7563.453;Inherit;False;Constant;_Vector16;Vector 16;57;0;Create;True;0;0;0;False;0;False;1,1,1;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.LightColorNode;1274;-540.0114,-7792.769;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.ClampOpNode;1413;-357.9854,-7817.52;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;1255;-612.1146,-8825.259;Inherit;False;1254;NdotL;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;1218;-185.7989,-8736.198;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;1363;1578.55,-7720.971;Inherit;False;DiffWrapLighting;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.IndirectDiffuseLighting;1348;-453.4719,-7661.961;Inherit;False;Tangent;1;0;FLOAT3;0,0,1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;1347;-618.4067,-7638.68;Inherit;False;1002;normalMap;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ClampOpNode;1315;960.473,-7765.595;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;1326;774.8737,-7811.25;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;1353;599.8019,-7785.855;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;1355;440.0456,-7804.675;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;1340;245.8069,-7857.576;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;1317;-247.0326,-7500.002;Inherit;False;Constant;_Color0;Color 0;57;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;1496;-252.4168,-7695.906;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;1,1,1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1497;261.7195,-8324.756;Inherit;False;Property;_WrapMetallicFesnelScale;Wrap Metallic Fesnel Scale;10;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;58;-761.1933,-6046.505;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1014;-2646.456,-7216.057;Inherit;False;Property;_UseUnityMetalicMap;Use Unity Metalic Map instead of MultiMap;9;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1017;-2664.991,-7082.698;Inherit;True;Property;_MetallicGlossMap;Unity Metallic;8;1;[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;ec89906eae50d364b8e936869463cc5e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;1356;1;1413;0
WireConnection;1356;2;1338;0
...
WireConnection;1355;1;1496;0
WireConnection;1340;0;1356;0
WireConnection;1340;2;1317;0
WireConnection;1496;0;1348;0
