...
Shader "VoyVivika/Vivika Shader/Vivika Shader Main"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 temp_output_99_0_g3070 = DiscardUV200;
			float2 break61_g3113 = temp_output_99_0_g3070;
			float2 break63_g3113 = floor( float2( 0,0 ) );
			float2 break61_g3116 = temp_output_99_0_g3070;
			float2 break63_g3116 = floor( float2( 0,1 ) );
			float2 break61_g3104 = temp_output_99_0_g3070;
			float2 break63_g3104 = floor( float2( 0,2 ) );
			float2 break61_g3110 = temp_output_99_0_g3070;
			float2 break63_g3110 = floor( float2( 0,3 ) );
			float2 break61_g3107 = temp_output_99_0_g3070;
			float2 break63_g3107 = floor( float2( 1,0 ) );
			float2 break61_g3095 = temp_output_99_0_g3070;
			float2 break63_g3095 = floor( float2( 1,1 ) );
			float2 break61_g3098 = temp_output_99_0_g3070;
			float2 break63_g3098 = floor( float2( 1,2 ) );
			float2 break61_g3101 = temp_output_99_0_g3070;
			float2 break63_g3101 = floor( float2( 1,3 ) );
			float2 break61_g3092 = temp_output_99_0_g3070;
			float2 break63_g3092 = floor( float2( 2,0 ) );
			float2 break61_g3089 = temp_output_99_0_g3070;
			float2 break63_g3089 = floor( float2( 2,1 ) );
			float2 break61_g3086 = temp_output_99_0_g3070;
			float2 break63_g3086 = floor( float2( 2,2 ) );
			float2 break61_g3083 = temp_output_99_0_g3070;
			float2 break63_g3083 = floor( float2( 2,3 ) );
			float2 break61_g3071 = temp_output_99_0_g3070;
			float2 break63_g3071 = floor( float2( 3,0 ) );
			float2 break61_g3074 = temp_output_99_0_g3070;
			float2 break63_g3074 = floor( float2( 3,1 ) );
			float2 break61_g3077 = temp_output_99_0_g3070;
			float2 break63_g3077 = floor( float2( 3,2 ) );
			float2 break61_g3080 = temp_output_99_0_g3070;
			float2 break63_g3080 = floor( float2( 3,3 ) );
			float UVTileDiscard192 = step( 1.0 , ( ( ( saturate( _UDIMDiscardRow0_0 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3113.x ) - break63_g3113.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3113.y ) - break63_g3113.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow1_0 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3116.x ) - break63_g3116.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3116.y ) - break63_g3116.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow2_0 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3104.x ) - break63_g3104.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3104.y ) - break63_g3104.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow3_0 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3110.x ) - break63_g3110.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3110.y ) - break63_g3110.y ) ) ) ) ) ) ) ) + ( ( saturate( _UDIMDiscardRow0_1 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3107.x ) - break63_g3107.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3107.y ) - break63_g3107.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow1_1 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3095.x ) - break63_g3095.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3095.y ) - break63_g3095.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow2_1 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3098.x ) - break63_g3098.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3098.y ) - break63_g3098.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow3_1 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3101.x ) - break63_g3101.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3101.y ) - break63_g3101.y ) ) ) ) ) ) ) ) + ( ( saturate( _UDIMDiscardRow0_2 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3092.x ) - break63_g3092.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3092.y ) - break63_g3092.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow1_2 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3089.x ) - break63_g3089.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3089.y ) - break63_g3089.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow2_2 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3086.x ) - break63_g3086.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3086.y ) - break63_g3086.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow3_2 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3083.x ) - break63_g3083.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3083.y ) - break63_g3083.y ) ) ) ) ) ) ) ) + ( ( saturate( _UDIMDiscardRow0_3 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3071.x ) - break63_g3071.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3071.y ) - break63_g3071.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow1_3 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3074.x ) - break63_g3074.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3074.y ) - break63_g3074.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow2_3 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3077.x ) - break63_g3077.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3077.y ) - break63_g3077.y ) ) ) ) ) ) ) + ( saturate( _UDIMDiscardRow3_3 ) * saturate( ( ( 1.0 - abs( sign( ( floor( break61_g3080.x ) - break63_g3080.x ) ) ) ) * ( 1.0 - abs( sign( ( floor( break61_g3080.y ) - break63_g3080.y ) ) ) ) ) ) ) ) ) );
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 color8_g3125 = IsGammaSpace() ? float4( 1, 1, 1, 1 ) : float4( 1, 1, 1, 1 );
			float2 uv_AmbientOcclusion = i.uv_texcoord * _AmbientOcclusion_ST.xy + _AmbientOcclusion_ST.zw;
			float4 temp_output_3_0_g3125 = ( 1.0 - ( ( 1.0 - tex2D( _AmbientOcclusion, uv_AmbientOcclusion ) ) * _AOStrength ) );
			float temp_output_9_0_g3125 = _RealAO;
			float4 lerpResult5_g3125 = lerp( color8_g3125 , temp_output_3_0_g3125 , temp_output_9_0_g3125);
			float4 temp_output_2629_0 = ( tex2D( _MainTex, uv_MainTex ) * lerpResult5_g3125 * _Color );
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;3140;1920,-4032;Inherit;False;Less or Equal (Float);-1;;3119;c206052517de386488d07c2846267e45;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;3138;1888,-4240;Inherit;False;Greater or Equal (Float);-1;;3121;9d883a649d0c24745bcf903b998f8f88;0;2;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;3075;2336,-4464;Inherit;False;Less or Equal (Float);-1;;3123;c206052517de386488d07c2846267e45;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2630;-1728,-3200;Inherit;False;VVAmbientOcclusion;-1;;3125;9931be4718b157b4ebb46a99812bfe31;0;3;6;FLOAT;0;False;7;COLOR;0,0,0,0;False;9;FLOAT;0;False;2;COLOR;11;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;3159;560,-2944;Inherit;False;Greater or Equal (Float);-1;;3126;9d883a649d0c24745bcf903b998f8f88;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;3164;560,-2784;Inherit;False;Less or Equal (Float);-1;;3128;c206052517de386488d07c2846267e45;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;3165;864,-2864;Inherit;False;Equal (Float);-1;;3130;0dacf0ec3269f3b7c8299909e77d796d;0;2;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=31E0E5EFB2EC98A7E395E898F0A9B116A3261034