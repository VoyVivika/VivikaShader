...
Shader "VoyVivika/VivikaShader/Vivika Shader Transparent"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 break63_g1362 = floor( float2( 0,0 ) );
			...
			float2 temp_output_99_0_g1349 = DiscardUV200;
			float2 break61_g1362 = temp_output_99_0_g1349;
			float2 break63_g1364 = floor( float2( 0,1 ) );
			float2 break61_g1364 = temp_output_99_0_g1349;
			float2 break63_g1361 = floor( float2( 0,2 ) );
			float2 break61_g1361 = temp_output_99_0_g1349;
			float2 break63_g1365 = floor( float2( 0,3 ) );
			float2 break61_g1365 = temp_output_99_0_g1349;
			float2 break63_g1363 = floor( float2( 1,0 ) );
			float2 break61_g1363 = temp_output_99_0_g1349;
			float2 break63_g1358 = floor( float2( 1,1 ) );
			float2 break61_g1358 = temp_output_99_0_g1349;
			float2 break63_g1359 = floor( float2( 1,2 ) );
			float2 break61_g1359 = temp_output_99_0_g1349;
			float2 break63_g1360 = floor( float2( 1,3 ) );
			float2 break61_g1360 = temp_output_99_0_g1349;
			float2 break63_g1357 = floor( float2( 2,0 ) );
			float2 break61_g1357 = temp_output_99_0_g1349;
			float2 break63_g1356 = floor( float2( 2,1 ) );
			float2 break61_g1356 = temp_output_99_0_g1349;
			float2 break63_g1355 = floor( float2( 2,2 ) );
			float2 break61_g1355 = temp_output_99_0_g1349;
			float2 break63_g1354 = floor( float2( 2,3 ) );
			float2 break61_g1354 = temp_output_99_0_g1349;
			float2 break63_g1350 = floor( float2( 3,0 ) );
			float2 break61_g1350 = temp_output_99_0_g1349;
			float2 break63_g1351 = floor( float2( 3,1 ) );
			float2 break61_g1351 = temp_output_99_0_g1349;
			float2 break63_g1352 = floor( float2( 3,2 ) );
			float2 break61_g1352 = temp_output_99_0_g1349;
			float2 break63_g1353 = floor( float2( 3,3 ) );
			float2 break61_g1353 = temp_output_99_0_g1349;
			float UVTileDiscard2690 = step( 1.0 , ( ( ( saturate( _UDIMDiscardRow0_0 ) * saturate( ( step( break63_g1362.x , break61_g1362.x ) * step( break61_g1362.x , ( break63_g1362.x + 0.9999999 ) ) * step( break63_g1362.y , break61_g1362.y ) * step( break61_g1362.y , ( break63_g1362.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow0_1 ) * saturate( ( step( break63_g1364.x , break61_g1364.x ) * step( break61_g1364.x , ( break63_g1364.x + 0.9999999 ) ) * step( break63_g1364.y , break61_g1364.y ) * step( break61_g1364.y , ( break63_g1364.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow0_2 ) * saturate( ( step( break63_g1361.x , break61_g1361.x ) * step( break61_g1361.x , ( break63_g1361.x + 0.9999999 ) ) * step( break63_g1361.y , break61_g1361.y ) * step( break61_g1361.y , ( break63_g1361.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow0_3 ) * saturate( ( step( break63_g1365.x , break61_g1365.x ) * step( break61_g1365.x , ( break63_g1365.x + 0.9999999 ) ) * step( break63_g1365.y , break61_g1365.y ) * step( break61_g1365.y , ( break63_g1365.y + 0.9999999 ) ) ) ) ) ) + ( ( saturate( _UDIMDiscardRow1_0 ) * saturate( ( step( break63_g1363.x , break61_g1363.x ) * step( break61_g1363.x , ( break63_g1363.x + 0.9999999 ) ) * step( break63_g1363.y , break61_g1363.y ) * step( break61_g1363.y , ( break63_g1363.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow1_1 ) * saturate( ( step( break63_g1358.x , break61_g1358.x ) * step( break61_g1358.x , ( break63_g1358.x + 0.9999999 ) ) * step( break63_g1358.y , break61_g1358.y ) * step( break61_g1358.y , ( break63_g1358.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow1_2 ) * saturate( ( step( break63_g1359.x , break61_g1359.x ) * step( break61_g1359.x , ( break63_g1359.x + 0.9999999 ) ) * step( break63_g1359.y , break61_g1359.y ) * step( break61_g1359.y , ( break63_g1359.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow1_3 ) * saturate( ( step( break63_g1360.x , break61_g1360.x ) * step( break61_g1360.x , ( break63_g1360.x + 0.9999999 ) ) * step( break63_g1360.y , break61_g1360.y ) * step( break61_g1360.y , ( break63_g1360.y + 0.9999999 ) ) ) ) ) ) + ( ( saturate( _UDIMDiscardRow2_0 ) * saturate( ( step( break63_g1357.x , break61_g1357.x ) * step( break61_g1357.x , ( break63_g1357.x + 0.9999999 ) ) * step( break63_g1357.y , break61_g1357.y ) * step( break61_g1357.y , ( break63_g1357.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow2_1 ) * saturate( ( step( break63_g1356.x , break61_g1356.x ) * step( break61_g1356.x , ( break63_g1356.x + 0.9999999 ) ) * step( break63_g1356.y , break61_g1356.y ) * step( break61_g1356.y , ( break63_g1356.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow2_2 ) * saturate( ( step( break63_g1355.x , break61_g1355.x ) * step( break61_g1355.x , ( break63_g1355.x + 0.9999999 ) ) * step( break63_g1355.y , break61_g1355.y ) * step( break61_g1355.y , ( break63_g1355.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow2_3 ) * saturate( ( step( break63_g1354.x , break61_g1354.x ) * step( break61_g1354.x , ( break63_g1354.x + 0.9999999 ) ) * step( break63_g1354.y , break61_g1354.y ) * step( break61_g1354.y , ( break63_g1354.y + 0.9999999 ) ) ) ) ) ) + ( ( saturate( _UDIMDiscardRow3_0 ) * saturate( ( step( break63_g1350.x , break61_g1350.x ) * step( break61_g1350.x , ( break63_g1350.x + 0.9999999 ) ) * step( break63_g1350.y , break61_g1350.y ) * step( break61_g1350.y , ( break63_g1350.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow3_1 ) * saturate( ( step( break63_g1351.x , break61_g1351.x ) * step( break61_g1351.x , ( break63_g1351.x + 0.9999999 ) ) * step( break63_g1351.y , break61_g1351.y ) * step( break61_g1351.y , ( break63_g1351.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow3_2 ) * saturate( ( step( break63_g1352.x , break61_g1352.x ) * step( break61_g1352.x , ( break63_g1352.x + 0.9999999 ) ) * step( break63_g1352.y , break61_g1352.y ) * step( break61_g1352.y , ( break63_g1352.y + 0.9999999 ) ) ) ) ) + ( saturate( _UDIMDiscardRow3_3 ) * saturate( ( step( break63_g1353.x , break61_g1353.x ) * step( break61_g1353.x , ( break63_g1353.x + 0.9999999 ) ) * step( break63_g1353.y , break61_g1353.y ) * step( break61_g1353.y , ( break63_g1353.y + 0.9999999 ) ) ) ) ) ) ) );
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float2 uv_BumpMap = i.uv_texcoord * _BumpMap_ST.xy + _BumpMap_ST.zw;
			float3 normalMap1002 = UnpackNormal( tex2D( _BumpMap, uv_BumpMap ) );
			float fresnelNdotV9_g1347 = dot( (WorldNormalVector( i , normalMap1002 )), ase_viewDirWS );
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2357;-2032,-2688;Inherit;False;Property;_ALDelayUVMap;AL Delay UV Map;24;2;[Header];[Enum];Create;True;0;5;UV0;0;UV1;1;UV2;2;UV3;3;Screen Space;8;0;True;0;False;2;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2542;-2000,-3280;Inherit;False;Property;_AOStrength;AO Strength;18;0;Create;True;0;0;0;False;0;False;1;0.5;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2540;-2032,-3216;Inherit;True;Property;_AmbientOcclusion;Ambient Occlusion;17;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2552;-1872,-3040;Inherit;False;Property;_RealAO;Real AO;19;1;[ToggleUI];Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2457;-32,-3168;Inherit;True;Property;_ALDelayMap;AudioLink Delay Tex Map;23;1;[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2708;-1952,-1168;Inherit;False;Property;_SmoothnessChannel;Smoothness Channel;14;1;[Enum];Create;False;0;2;Alpha;0;Green;1;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;979;160,-2976;Inherit;False;Property;_ALUVDelayMaxDelay;AL UV Delay Max Delay;25;0;Create;True;0;0;0;False;0;False;0;127;0;127;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;243;1472,-3040;Inherit;False;Property;_ALTimeScale;AL HueShift Time Scale;26;0;Create;False;0;0;0;False;0;False;0;0.25;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2313;-2016,-2400;Inherit;False;Property;_DiscardUVMap;Discard UV Map;31;2;[Header];[Enum];Create;True;1;UV Tile Discarding;4;UV0;0;UV1;1;UV2;2;UV3;3;0;True;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;40;80,-2608;Inherit;True;Property;_AL_Mask;AudioLink Mask;22;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2634;-1328,-640;Inherit;True;VivikaShading;-1;;1301;efce34b3f4a0e2b44933c4737d48061f;0;11;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;3;False;9;FLOAT;0;False;10;FLOAT;0;False;11;FLOAT3;0,0,0;False;12;FLOAT;0;False;13;FLOAT;0;False;18;COLOR;0,0,0,0;False;2;FLOAT3;32;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2687;1376,-1264;Inherit;False;1050.305;1191.881;Comment;19;2706;2705;2704;2703;2702;2701;2700;2699;2698;2697;2696;2695;2694;2693;2692;2691;2690;2689;2688;UV Tile Discard;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2670;2999.86,-364.2664;Inherit;False;Property;_DontRenderinSocialVRMirrors;Don't Render in Social VR Mirrors;51;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2668;2999.86,-956.2664;Inherit;False;Property;_DontRenderInSocialVRCameras;Don't Render in Social VR Cameras;50;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2692;1408,-1152;Inherit;False;Property;_UDIMDiscardRow0_1;Discard UV Tile 0,1;33;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2693;1408,-1088;Inherit;False;Property;_UDIMDiscardRow0_2;Discard UV Tile 0,2;34;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2694;1408,-1024;Inherit;False;Property;_UDIMDiscardRow0_3;Discard UV Tile 0,3;35;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2695;1408,-960;Inherit;False;Property;_UDIMDiscardRow1_0;Discard UV Tile 1,0;36;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2696;1408,-896;Inherit;False;Property;_UDIMDiscardRow1_1;Discard UV Tile 1,1;37;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2697;1408,-832;Inherit;False;Property;_UDIMDiscardRow1_2;Discard UV Tile 1,2;38;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2698;1408,-768;Inherit;False;Property;_UDIMDiscardRow1_3;Discard UV Tile 1,3;39;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2699;1408,-704;Inherit;False;Property;_UDIMDiscardRow2_0;Discard UV Tile 2,0;40;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2700;1408,-640;Inherit;False;Property;_UDIMDiscardRow2_1;Discard UV Tile 2,1;41;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2701;1408,-576;Inherit;False;Property;_UDIMDiscardRow2_2;Discard UV Tile 2,2;42;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2702;1408,-512;Inherit;False;Property;_UDIMDiscardRow2_3;Discard UV Tile 2,3;43;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2703;1408,-448;Inherit;False;Property;_UDIMDiscardRow3_0;Discard UV Tile 3,0;45;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2704;1408,-384;Inherit;False;Property;_UDIMDiscardRow3_1;Discard UV Tile 3,1;44;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2705;1408,-320;Inherit;False;Property;_UDIMDiscardRow3_2;Discard UV Tile 3,2;46;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2706;1408,-256;Inherit;False;Property;_UDIMDiscardRow3_3;Discard UV Tile 3,3;47;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2691;1408,-1216;Inherit;False;Property;_UDIMDiscardRow0_0;Discard UV Tile 0,0;32;1;[ToggleUI];Create;False;1;UV Tile Discard;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2614;-1200,-1744;Inherit;False;Property;_ALEmitifInactive;AL Emit if Inactive;21;1;[ToggleUI];Create;False;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;415;-1264,-1808;Half;False;Property;_EnableAudioLink;Enable AudioLink;20;2;[Header];[ToggleUI];Create;True;1;AudioLink;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;113;96,-848;Inherit;False;Property;_RimBaseColorStrength;Rim Base Color Strength;30;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;87;96,-912;Inherit;False;Property;_RimEnergy;Rim Energy;29;0;Create;True;0;0;0;False;0;False;0.345;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;12;96,-976;Float;False;Property;_RimPower;Rim Power;28;0;Create;True;0;0;0;False;0;False;2.07;1.86;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;333;96,-1040;Half;False;Property;_EnableRimLighting;Enable Rim Lighting;27;1;[ToggleUI];Create;True;0;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2616;-720,-2336;Inherit;False;VVALCombine;-1;;1325;bceeba5c9c06c59459d6b7e4bf2084da;0;9;54;FLOAT;0;False;55;INT;0;False;25;COLOR;1,0,0,1;False;27;COLOR;1,0.9294118,0,1;False;26;COLOR;0,0.8196079,0,1;False;28;COLOR;0,0,1,1;False;51;COLOR;0,0,0,0;False;52;FLOAT;0;False;53;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2620;496,-912;Inherit;False;Rim;-1;;1347;652e8c2aadb4b694999944f1079d1366;0;7;29;FLOAT;0;False;30;FLOAT;0;False;31;FLOAT;0;False;32;FLOAT;0;False;26;FLOAT3;0,0,0;False;27;FLOAT3;0,0,0;False;28;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2709;2872.272,-1629.46;Inherit;False;Property;_UDIMDiscardAll;Discard All;48;1;[ToggleUI];Create;False;1;The Following Setting Completely Disables Rendering whatever is using this material. This works similarly to UV Tile Discarding.;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2567;-1648,-144;Inherit;False;Property;_MetallicFresnelPower;Metallic Fresnel Power;16;0;Create;True;0;0;0;False;0;False;3;3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;1497;-1616,-208;Inherit;False;Property;_WrapMetallicFesnelScale;Metallic Fesnel Scale;15;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode, AmplifyShaderEditor, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null;2638;-410.2572,-4041.429;Inherit;True;Property;_EmissionMap;Fallback Emission Map;49;1;[SingleLineTexture];Create;False;0;0;0;True;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
WireConnection;2689;100;2691;0
WireConnection;2689;101;2692;0
WireConnection;2689;102;2693;0
WireConnection;2689;103;2694;0
WireConnection;2689;104;2695;0
WireConnection;2689;105;2696;0
WireConnection;2689;106;2697;0
WireConnection;2689;107;2698;0
WireConnection;2689;108;2699;0
WireConnection;2689;109;2700;0
WireConnection;2689;110;2701;0
WireConnection;2689;111;2702;0
WireConnection;2689;112;2703;0
WireConnection;2689;113;2704;0
WireConnection;2689;114;2705;0
WireConnection;2689;115;2706;0
WireConnection;2689;99;2688;0
...
WireConnection;2690;0;2689;116
...
ASEEND*/
//CHKSM=9B191139015A5C882168237AA4C6E7F0E5477325